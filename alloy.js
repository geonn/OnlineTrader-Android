...
// APP URL called
Ti.API.CHECKSESSION = "http://"+Ti.API.API_DOMAIN+"/api/checkSession?version=1.0.51&user="+Ti.API.USER+"&key="+Ti.API.KEY+"&session=";
Ti.API.LOGIN        = "http://"+Ti.API.API_DOMAIN+"/api/loginUser?version=1.0.1&user="+Ti.API.USER+"&key="+Ti.API.KEY;
